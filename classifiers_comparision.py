...
starline = "\n"+"*"*50+"\n"
output_file_str = ""
output_file_str += "\nThis file is automatically generated by executing the file 'classifiers_comparision.py'\n"
...
def timer(func):
    def wrapper(*args,**kwargs):
        ...
        func(*args,**kwargs)
        time2 = time()
        output_file_str += func.__name__+" function took "+str((time2-time1)/60)[:6]+" min (or) "+str(time2-time1)[:6]+" sec"+starline
    return wrapper
...
def logistic_regression(trainsize=0.5, ng_min=1, ng_max=1):
    ...
    output_file_str += "Train shape: "+str(X_train.shape)+"\nTest shape: "+str(X_test.shape)+"\n"
